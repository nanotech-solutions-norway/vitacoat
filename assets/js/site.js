document.addEventListener('DOMContentLoaded', () => {
  ...
  const imageMap = {
    ...
    'vitacoat-applications-panel.svg': 'vitacoat-applications-panel.jpeg', 'vitacoat-application-process.svg': 'vitacoat-application-process.jpeg',
    'vitacoat-testing-standards.svg': 'vitacoat-testing-standards.jpeg', 'vitacoat-durability.svg': 'vitacoat-durability.jpeg',
    'vitacoat-safety-environment.svg': 'vitacoat-safety-environment.jpeg', 'vitacoat-pathogen-spectrum.svg': 'vitacoat-pathogen-spectrum.jpeg',
    'vitacoat-easier-cleaning.svg': 'vitacoat-easier-cleaning.jpeg', 'vitacoat-contact-panel.svg': 'vitacoat-contact-panel.jpeg',
    'technical-support-hero-01.svg': 'technical-support-hero-01.jpeg'
  };

  const heroMap = {
    '/': 'frontpage-hero.jpg', '/applications/': 'vitacoat-applications-panel.jpeg', '/applications/healthcare/': 'vitacoat-healthcare-application.jpg',
    '/applications/food-processing/': 'vitacoat-food-processing-application.jpg', '/applications/public-facilities/': 'vitacoat-public-facilities-application.jpg',
    '/applications/education-and-offices/': 'vitacoat-education-offices-application.jpg', '/applications/electronics-and-touchpoints/': 'vitacoat-electronics-touchpoints-application.jpg',
    '/how-it-works/': 'frontpage-three-mechanisms-one-continuous-barrier.jpeg', '/benefits/continuous-protection/': 'frontpage-three-mechanisms-one-continuous-barrier.jpeg',
    '/benefits/easier-cleaning/': 'vitacoat-easier-cleaning.jpeg', '/benefits/surface-compatibility/': 'applications-hard-surface-compatibility.jpeg',
    '/proof/testing-and-standards/': 'vitacoat-testing-standards.jpeg', '/proof/durability/': 'vitacoat-durability.jpeg',
    '/proof/safety-and-environment/': 'vitacoat-safety-environment.jpeg', '/proof/pathogen-spectrum/': 'vitacoat-pathogen-spectrum.jpeg',
    '/application-process/': 'vitacoat-application-process.jpeg', '/maintenance/': 'vitacoat-maintenance.jpeg', '/reapplication/': 'vitacoat-reapplication.jpeg',
    '/maintenance-and-reapplication/': 'vitacoat-maintenance.jpeg', '/documentation/': 'vitacoat-documentation-panel.jpg',
    '/technical-support/': 'technical-support-hero-01.jpeg', '/technical-support/downloads/': 'vitacoat-download-center.jpeg',
    '/contact/': 'vitacoat-contact-panel.jpeg', '/faq/': 'frontpage-surface-environment-fit-assessment.jpeg', '/legal/': 'vitacoat-legal-claim-boundaries.jpeg'
  };

  const pageRequiredImages = {
    '/': ['frontpage-hero.jpg', 'frontpage-five-reasons-facilities-trust-vitacoat.jpeg', 'frontpage-three-mechanisms-one-continuous-barrier.jpeg', 'frontpage-routine-disinfection-vs-vitacoat-protection-model.jpeg', 'frontpage-en-backed-performance-data.jpeg', 'frontpage-coating-integrity-real-world-conditions.jpeg', 'frontpage-surface-environment-fit-assessment.jpeg'],
    '/applications/': ['vitacoat-applications-panel.jpeg', 'applications-graph-01.jpeg'],
    '/applications/healthcare/': ['vitacoat-healthcare-application.jpg'],
    '/applications/food-processing/': ['vitacoat-food-processing-application.jpg'],
    '/applications/public-facilities/': ['vitacoat-public-facilities-application.jpg'],
    '/applications/education-and-offices/': ['vitacoat-education-offices-application.jpg'],
    '/applications/electronics-and-touchpoints/': ['vitacoat-electronics-touchpoints-application.jpg'],
    '/how-it-works/': ['frontpage-three-mechanisms-one-continuous-barrier.jpeg'],
    '/benefits/continuous-protection/': ['frontpage-three-mechanisms-one-continuous-barrier.jpeg', 'frontpage-routine-disinfection-vs-vitacoat-protection-model.jpeg'],
    '/benefits/easier-cleaning/': ['vitacoat-easier-cleaning.jpeg'],
    '/benefits/surface-compatibility/': ['applications-hard-surface-compatibility.jpeg'],
    '/proof/testing-and-standards/': ['vitacoat-testing-standards.jpeg', 'frontpage-en-backed-performance-data.jpeg'],
    '/proof/durability/': ['vitacoat-durability.jpeg', 'vitacoat-durability-inspection.jpeg', 'frontpage-coating-integrity-real-world-conditions.jpeg'],
    '/proof/safety-and-environment/': ['vitacoat-safety-environment.jpeg'],
    '/proof/pathogen-spectrum/': ['vitacoat-pathogen-spectrum.jpeg'],
    '/application-process/': ['vitacoat-application-process.jpeg', 'application-process-specification-at-a-glance.jpeg'],
    '/maintenance/': ['vitacoat-maintenance.jpeg'],
    '/reapplication/': ['vitacoat-reapplication.jpeg'],
    '/maintenance-and-reapplication/': ['vitacoat-maintenance.jpeg', 'vitacoat-reapplication.jpeg'],
    '/documentation/': ['vitacoat-documentation-panel.jpg'],
    '/technical-support/': ['technical-support-hero-01.jpeg'],
    '/technical-support/downloads/': ['vitacoat-download-center.jpeg'],
    '/contact/': ['vitacoat-contact-panel.jpeg'],
    '/faq/': ['frontpage-surface-environment-fit-assessment.jpeg'],
    '/legal/': ['vitacoat-legal-claim-boundaries.jpeg']
  };

  const expectedImages = Array.from(new Set(Object.values(pageRequiredImages).flat()));

  const placeholderSvg = filename => {
    const safe = String(filename || 'missing-image.jpeg').replace(/[<>&]/g, '');
    return `data:image/svg+xml;charset=UTF-8,${encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" width="1600" height="900" viewBox="0 0 1600 900"><defs><linearGradient id="g" x1="0" x2="1" y1="0" y2="1"><stop offset="0" stop-color="#f5f4ef"/><stop offset="1" stop-color="#eceaf9"/></linearGradient></defs><rect width="1600" height="900" rx="30" fill="url(#g)"/><rect x="42" y="42" width="1516" height="816" rx="28" fill="none" stroke="#4950bc" stroke-width="8" stroke-dasharray="26 18"/><text x="800" y="265" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="42" font-weight="800" fill="#4950bc">MISSING IMAGE PLACEHOLDER</text><text x="800" y="410" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="58" font-weight="900" fill="#171717">${safe}</text><text x="800" y="520" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="32" font-weight="700" fill="#4b5563">Upload manually to:</text><text x="800" y="575" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="34" font-weight="900" fill="#111827">/assets/img/${safe}</text><text x="800" y="690" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="26" fill="#6b7280">Use exactly this filename to replace the dummy image.</text></svg>`)}`;
  };
  ...
  const css = `
    ...
    .vc-missing-image-placeholder{object-fit:contain!important;background:#f5f4ef!important;border:2px dashed #4950bc!important;border-radius:18px!important;box-shadow:0 10px 28px rgba(15,23,42,.08)!important}.vc-image-placeholder-section{display:none}.vc-image-placeholder-section.has-missing{display:block}.vc-image-placeholder-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.vc-image-placeholder-card img{width:100%;aspect-ratio:16/9;height:auto;display:block}.vc-image-placeholder-card .small-note{margin-top:8px;font-size:12px;color:#5b6270;word-break:break-word}
  ...
  const makeLanguageSwitch = cls => { const wrap = document.createElement('div'); wrap.className = `language-switcher flag-language-switcher ${cls || ''}`; [['🇳🇴', noPath, !isEn, 'no', 'Norsk'], ['🇬🇧', enPath, isEn, 'en', 'English']].forEach(([flag, href, activeLang, code, label]) => { const a = document.createElement('a'); a.href = href; a.textContent = flag; a.className = `language-link flag-language-link${activeLang ? ' active-lang' : ''}`; a.setAttribute('hreflang', code); a.setAttribute('aria-label', label); a.title = label; a.addEventListener('click', () => setLanguage(code)); wrap.appendChild(a); }); return wrap; };
  ...
  if (nav) { nav.innerHTML = ''; const closeTimers = new WeakMap(); columns.forEach(col => { const dd = document.createElement('div'); dd.className = 'nav-dropdown'; const top = document.createElement('a'); top.href = col.href; top.textContent = col.title; if (active(col.href, col.links)) top.classList.add('active'); dd.appendChild(top); const menu = document.createElement('div'); menu.className = 'dropdown-menu'; col.links.forEach(([label, href]) => { const a = document.createElement('a'); a.href = href; a.textContent = label; menu.appendChild(a); }); dd.appendChild(menu); const open = () => { clearTimeout(closeTimers.get(dd)); nav.querySelectorAll('.nav-dropdown.is-open').forEach(x => { if (x !== dd) x.classList.remove('is-open'); }); dd.classList.add('is-open'); }; const close = () => { clearTimeout(closeTimers.get(dd)); closeTimers.set(dd, setTimeout(() => dd.classList.remove('is-open'), 1000)); }; dd.addEventListener('pointerenter', open); dd.addEventListener('pointerleave', close); nav.appendChild(dd); }); }

  const headerInner = document.querySelector('.header-inner'); const menuToggle = document.querySelector('.menu-toggle');
  ...
  const mobile = document.querySelector('.mobile-nav'); const mobileContainer = document.querySelector('.mobile-nav .container');
  if (mobileContainer) { mobileContainer.innerHTML = ''; columns.forEach(col => { const group = document.createElement('div'); group.className = 'mobile-nav-group'; const main = document.createElement('a'); main.href = col.href; main.textContent = col.title; main.className = 'mobile-main-link'; group.appendChild(main); col.links.forEach(([label, href]) => { const a = document.createElement('a'); a.href = href; a.textContent = label; a.className = 'mobile-subnav-link'; group.appendChild(a); }); mobileContainer.appendChild(group); }); mobileContainer.appendChild(makeLanguageSwitch('mobile-language-switcher')); }
  if (menuToggle && mobile) { menuToggle.type = 'button'; menuToggle.innerHTML = '<span class="hamburger-icon" aria-hidden="true">☰</span><span class="sr-only">Menu</span>'; menuToggle.setAttribute('aria-expanded','false'); menuToggle.addEventListener('click', e => { e.preventDefault(); const open = mobile.classList.toggle('open'); menuToggle.setAttribute('aria-expanded', open ? 'true' : 'false'); document.body.classList.toggle('mobile-menu-open', open); }); mobile.addEventListener('click', e => { if (e.target && e.target.tagName === 'A') { mobile.classList.remove('open'); menuToggle.setAttribute('aria-expanded','false'); document.body.classList.remove('mobile-menu-open'); } }); }

  document.querySelectorAll('.site-footer .footer-grid').forEach(f => { f.innerHTML = ''; const logo = document.createElement('a'); logo.href = routes.home; logo.className = 'footer-top-logo'; f.appendChild(logo); columns.forEach(col => { const c = document.createElement('div'); c.className = 'footer-column'; const h = document.createElement('h4'); const a = document.createElement('a'); a.href = col.href; a.textContent = col.title; h.appendChild(a); const ul = document.createElement('ul'); ul.className = 'footer-links'; col.links.forEach(([label, href]) => { const li = document.createElement('li'); const l = document.createElement('a'); l.href = href; l.textContent = label; li.appendChild(l); ul.appendChild(li); }); c.appendChild(h); c.appendChild(ul); f.appendChild(c); }); const box = document.createElement('div'); box.className = 'footer-language'; box.appendChild(makeLanguageSwitch('footer-language-switcher')); f.appendChild(box); });

  const fileFromSrc = src => (src || '').split('/').pop().split('?')[0].split('#')[0]; const asset = name => `/assets/img/${name}`;
  const hero = document.querySelector('.hero-media img'); if (hero && heroMap[basePath]) { hero.src = asset(heroMap[basePath]); showPlaceholderIfMissing(hero, heroMap[basePath]); }
  document.querySelectorAll('main img[src^="/assets/img/"]').forEach(img => { const current = fileFromSrc(img.getAttribute('src')); const next = imageMap[current] || current; if (next && !/logo|favicon/i.test(next)) { img.src = asset(next); showPlaceholderIfMissing(img, next); } });

  const currentFiles = () => new Set(Array.from(document.querySelectorAll('main img[src^="/assets/img/"]')).map(img => fileFromSrc(img.getAttribute('src'))).filter(Boolean));
  const ensureMissingImageSection = () => {
    const required = Array.from(new Set(pageRequiredImages[basePath] || []));
    if (!required.length) return;
    const seen = currentFiles();
    const missingCandidates = required.filter(name => !seen.has(name));
    if (!missingCandidates.length) return;
    const main = document.querySelector('main'); if (!main) return;
    const section = document.createElement('section'); section.className = 'section vc-image-placeholder-section';
    section.innerHTML = `<div class="container panel"><div class="eyebrow">${isEn ? 'Manual image replacement' : 'Manuell bildeerstatning'}</div><h2>${isEn ? 'Missing image placeholders' : 'Manglende bildeplassholdere'}</h2><p>${isEn ? 'Only missing assets are shown here. If the image has already been uploaded to /assets/img/, this placeholder will not appear.' : 'Kun manglende bildefiler vises her. Hvis bildet allerede er lastet opp til /assets/img/, vises ikke denne plassholderen.'}</p><div class="vc-image-placeholder-grid"></div></div>`;
    const grid = section.querySelector('.vc-image-placeholder-grid');
    let pending = missingCandidates.length;
    missingCandidates.forEach(name => {
      const probe = new Image();
      probe.onload = () => { pending -= 1; if (pending === 0 && !grid.children.length) section.remove(); };
      probe.onerror = () => {
        section.classList.add('has-missing');
        const card = document.createElement('article'); card.className = 'card vc-image-placeholder-card';
        const img = document.createElement('img'); img.src = placeholderSvg(name); img.alt = `Missing image placeholder for ${name}`; img.title = `Upload required: /assets/img/${name}`; img.className = 'vc-missing-image-placeholder';
        const note = document.createElement('div'); note.className = 'small-note'; note.textContent = `/assets/img/${name}`;
        card.appendChild(img); card.appendChild(note); grid.appendChild(card); pending -= 1;
      };
      probe.src = asset(name);
    });
    const insertAfter = document.querySelector('main .hero') || document.querySelector('main .section');
    if (insertAfter && insertAfter.parentNode) insertAfter.insertAdjacentElement('afterend', section); else main.appendChild(section);
  };

  window.vitacoatExpectedImages = expectedImages.slice(); window.vitacoatPageRequiredImages = pageRequiredImages;
  ...
  const makeChart = () => { const box = document.createElement('div'); box.className = 'vc-log-chart'; box.setAttribute('role', 'img'); box.setAttribute('aria-label', 'Log reduction bar chart for VitaCoat test standards.'); const inner = document.createElement('div'); inner.className = 'vc-log-chart-inner'; const title = document.createElement('div'); title.className = 'vc-log-chart-title'; title.textContent = 'Test Standard'; inner.appendChild(title); labels.forEach((label, i) => { const row = document.createElement('div'); row.className = 'vc-chart-row'; const y = document.createElement('div'); y.className = 'vc-y-label'; y.textContent = label; const track = document.createElement('div'); track.className = 'vc-track'; const bar = document.createElement('div'); bar.className = 'vc-bar'; bar.style.setProperty('--w', data[i].width); bar.style.setProperty('--c', data[i].color); bar.dataset.label = label; bar.dataset.value = data[i].value; bar.textContent = data[i].value; track.appendChild(bar); row.appendChild(y); row.appendChild(track); inner.appendChild(row); }); const axis = document.createElement('div'); axis.className = 'vc-axis'; axis.appendChild(document.createElement('div')); const tickBox = document.createElement('div'); tickBox.className = 'vc-axis-ticks'; ticks.forEach(t => { const s = document.createElement('span'); s.textContent = t; tickBox.appendChild(s); }); const axisTitle = document.createElement('div'); axisTitle.className = 'vc-axis-title'; axisTitle.textContent = 'Log Reduction'; axis.appendChild(tickBox); axis.appendChild(axisTitle); inner.appendChild(axis); box.appendChild(inner); requestAnimationFrame(() => setTimeout(() => box.querySelectorAll('.vc-bar').forEach(b => b.classList.add('is-animated')), 120)); return box; };
  const addChart = () => { if (!['/', '/proof/testing-and-standards/'].includes(basePath)) return; const heading = isEn ? 'EN-Backed Performance Data' : 'EN-støttede ytelsesdata'; const eyebrow = isEn ? 'Standards & Efficacy' : 'Standarder og effekt'; const intro = isEn ? 'The chart shows measured logarithmic reduction across relevant antimicrobial test categories. Higher log-reduction values indicate stronger microbial reduction: 5 log corresponds to 99.999% reduction, 4 log to 99.99%, and 2.3 log to approximately 99.5% under the stated test conditions.' : 'Grafen viser målt logaritmisk reduksjon på tvers av relevante antimikrobielle testkategorier. Høyere log-reduksjon betyr sterkere mikrobiell reduksjon: 5 log tilsvarer 99,999 %, 4 log tilsvarer 99,99 %, og 2,3 log tilsvarer omtrent 99,5 % under de angitte testbetingelsene.'; const caution = isEn ? 'Values must be assessed with the underlying method, contact time, substrate, application quality and laboratory conditions. The graph is a technical evidence summary, not a universal sterilization or broad virucidal claim.' : 'Verdiene må vurderes sammen med metode, kontakttid, substrat, applikasjonskvalitet og laboratoriebetingelser. Grafen er et teknisk evidenssammendrag, ikke et universelt steriliserings- eller bredt virucidalt claim.'; const section = document.createElement('section'); section.className = 'section vc-performance-chart-section'; section.innerHTML = `<div class="container panel"><div class="eyebrow">${eyebrow}</div><h2 align="center">${heading}</h2><p align="center" class="vc-chart-explainer">${intro}</p><div class="vc-chart-copy"><div class="vc-chart-slot"></div><div class="callout">${caution}</div></div></div>`; section.querySelector('.vc-chart-slot').appendChild(makeChart()); const old = document.querySelector('.bar-group'); if (old && old.closest('.section')) { old.closest('.section').replaceWith(section); return; } if (document.querySelector('.vc-performance-chart-section')) return; const main = document.querySelector('main'); const heroSection = main && main.querySelector('.hero'); const after = heroSection ? heroSection.nextElementSibling : null; if (after) after.insertAdjacentElement('afterend', section); else if (main) main.appendChild(section); };
  addChart(); ensureMissingImageSection();
});
