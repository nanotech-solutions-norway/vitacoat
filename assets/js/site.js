document.addEventListener('DOMContentLoaded', () => {
  ...
  if (mobileContainer) {
    ...
    columns.forEach(col => {
      ...
      const main = document.createElement('a'); main.href = col.href; main.textContent = col.title; group.appendChild(main);
  ...
  if (menuToggle && mobile) {
    ...
    menuToggle.addEventListener('click', e => { e.preventDefault(); mobile.classList.toggle('open'); });
  }
